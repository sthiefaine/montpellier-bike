...
export async function GET(
  ...
  const date = (await params).date || "2025-01-01";
  ...
  let openDataSomme = 0;
  let url = `https://portail-api-data.montpellier3m.fr/ecocounter_timeseries/urn%3Angsi-ld%3AEcoCounter%3A${numero_serie}/attrs/intensity?fromDate=${openDataStartDateISO}`;
